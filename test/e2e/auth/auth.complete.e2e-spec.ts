...
import { UserFactory, UserFactoryResult } from '../../factories/user.factory';
import { BranchFactory, BranchFactoryResult } from '../../factories/branch.factory';
import { RoleFactory, RoleFactoryResult } from '../../factories/role.factory';
...
describe('Auth - Complete E2E', () => {
  ...
  let userData: UserFactoryResult;
  let branchData: BranchFactoryResult;
  let roleData: RoleFactoryResult;
  ...
  describe('POST /auth/user/verify-phone - Verify Phone Number', () => {
    ...
    beforeEach(async () => {
      ...
      verificationCode = (await redis.get(`verification:${phoneNumber}`)) as string;
    });
