...
describe('AdminsService', () => {
  ...
  beforeEach(async () => {
    ...
    (knexMock as unknown as jest.Mock).mockImplementation((table: string) => {
  ...
  describe('create', () => {
    ...
    it('should create admin successfully', async () => {
      ...
      (redisServiceMock.del as jest.Mock).mockResolvedValue(1);
  ...
  describe('cache management', () => {
    ...
    it('should handle Redis errors gracefully', async () => {
      ...
      knexMock.transaction.mockImplementation((callback) => callback(trxMock));
      (redisServiceMock.del as jest.Mock).mockRejectedValue(new Error('Redis error'));
