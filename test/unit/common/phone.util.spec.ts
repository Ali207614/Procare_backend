...
describe('phone.util', () => {
  ...
  it('returns both normalized and legacy lookup candidates', () => {
    expect(getUzPhoneLookupCandidates('976191611')).toEqual(['+998976191611', '976191611']);
    expect(getUzPhoneLookupCandidates('+998976191611')).toEqual(['+998976191611', '976191611']);
  });
