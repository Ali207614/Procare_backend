...
exports.seed = async function (knex) {
  ...
  const permissions = [
    ...
    // Status permissions
    { id: '00000000-0000-0000-0000-000000000009', name: 'status.read', description: 'Statuslarni ko‘rish huquqi' },
    ...
    // Status Permission
    { id: '00000000-0000-0000-0000-000000000013', name: 'status_permission.read', description: 'Status permissionlarni ko‘rish huquqi' },
    ...
    // Branch CRUD
    { id: '00000000-0000-0000-0000-000000000025', name: 'branch.read', description: 'Filiallarni ko‘rish huquqi' },
    ...
    // Brand CRUD
    { id: '00000000-0000-0000-0000-000000000029', name: 'brand.read', description: 'Brandlarni ko‘rish huquqi' },
    ...
    // Phone CRUD
    { id: '00000000-0000-0000-0000-000000000033', name: 'phone.read', description: 'Telefonlarni ko‘rish huquqi' },
    ...
    // Problem CRUD
    { id: '00000000-0000-0000-0000-000000000037', name: 'problem.read', description: 'Muammolarni ko‘rish huquqi' },
