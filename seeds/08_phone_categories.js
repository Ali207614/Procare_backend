exports.seed = async function (knex) {
  ...
  const phoneCategories = [
    ...
    // Samsung Models
    {
      ...
      phone_os_type_id: androidType?.id,
      parent_id: '10000000-0000-4000-8000-000000000020',
      sort: 1,
    },
    {
    ...
    // Xiaomi Models
    {
      ...
      name_en: 'Mi 14 Ultra',
      phone_os_type_id: androidType?.id,
      parent_id: '10000000-0000-4000-8000-000000000030',
      sort: 1,
    },
    {
    ...
    },
    {
      ...
      phone_os_type_id: androidType?.id,
      parent_id: '10000000-0000-4000-8000-000000000040',
      sort: 1,
    },
    {
    ...
    },
    {
      ...
      name_en: 'X100 Pro',
      phone_os_type_id: androidType?.id,
      parent_id: '10000000-0000-4000-8000-000000000050',
      sort: 1,
    },
    {
